...
// this. It's not allowed to use an if...else statement (if it's easier for you, you 
// can start with an if...else statement, and then try to convert it to a ternary 
// operator).Print a string to the console containing the bill value, the tip, and 
// the final value (bill + tip). Example: The bill was 275, the tip was 41.25, and 
...
if (bill >= 50 && bill <= 300){
    ...
    console.log(`There is no tip for $${bill} *2`)
}
